...
\begin{figure}[h!]
  ...
  \caption{The difference between the true and reconstructed values of the missing transverse momentum in a gluon fusion signal sample using both track-based ($\MPTj$) and calorimeter-based $\MET$ definitions.}
...
\begin{figure}[h!]
  ...
  \caption{The difference between the true and reconstructed values of $\mTH$ in a gluon fusion signal sample using both track-based ($\MPTj$) and calorimeter-based $\MET$ definitions.}
