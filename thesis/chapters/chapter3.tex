...
\section{Jet characteristics of VBF $\HWW$ production}
...
\begin{figure}[h!]
  ...
  %\hspace*{-32pt}
  \raisebox{-0.5\height}{\includegraphics[width=0.4\textwidth]{figures/Feyn_ttbar}}
  \hspace{20pt}
  \raisebox{-0.5\height}{\includegraphics[width=0.4\textwidth]{figures/Feyn_Wt}}
