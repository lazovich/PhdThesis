...
\begin{figure}[h!]
  ...
  \includegraphics[width=0.5\textwidth]{figures/B_decay_dist}
  \caption{Distance traveled (in the transverse plane) by $B$-hadrons before decay for different signal masses in RSG $c=1$ models. Vertical lines denote where the IBL and first pixel layers begin. }
