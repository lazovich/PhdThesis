...
\begin{figure}[h!]
  ...
  \includegraphics[width=0.5\textwidth]{figures/stgc}
   \caption{Geometry of the sTGC detector~\cite{NSW_TDR}. The wire plane acts as the anode, while carbon cathodes are capacitively coupled to pickup strips and pads.}
  \label{fig:stgc}
\end{figure}
