...
\end{tabular}
\caption{
Parameters derived for exponential fit to background $M_{JJ}$ shape in the $3b$ and $4b$ signal regions~\cite{Qi}
}
\label{tab:shape_fit}
\end{table}
